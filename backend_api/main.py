...
async def chat_with_bot(query: ChatQuery):
    user_message = query.user_message.lower().strip()
    prolog_q_made = ""
    ...
    if user_message in greetings:
    ...
    elif user_message in heart_emojis:
        ...
        try:
            if "your name" in user_message or user_message == "name" or "what is your name" in user_message:
                ...
                response_text = "This is Dhinesh E's personal portfolio website: https://dhinesh7-cit.github.io"

            elif "lover" in user_message:
                prolog_q_made = "lover_intent"
